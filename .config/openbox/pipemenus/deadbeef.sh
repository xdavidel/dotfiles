...
playlist_dir=`/home/david/.config/deadbeef/playlists/`
playlist_num=`ls -l /home/david/.config/deadbeef/playlists/* | wc -l | sed -n '1p'`
...
for file in $(ls /home/david/.config/deadbeef/playlists/*.dbpl -1v); do
