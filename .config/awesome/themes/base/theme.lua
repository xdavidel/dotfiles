...
theme.color = {
	-- main colors
	main      = xrdb.color13 or "#02606D",
	gray      = xrdb.color8  or "#575757",
	bg        = xrdb.color0  or "#161616",
	bg_second = xrdb.color8  or "#181818",
	wibox     = xrdb.color0  or "#202020",
	icon      = xrdb.color15 or "#a0a0a0",
	text      = xrdb.color7  or "#aaaaaa",
	urgent    = xrdb.color1  or "#B25500",
	highlight = xrdb.color7  or "#e0e0e0",
	border    = xrdb.color13  or "#404040",
...
-- Common
-----------------------------------------------------------------------------------------------------------------------
theme.path = awful.util.get_configuration_dir() .. "themes/base"
theme.base = awful.util.get_configuration_dir() .. "themes/base"
...
theme.wallpaper = theme.homedir .. "/.config/wall.png" -- wallpaper file
